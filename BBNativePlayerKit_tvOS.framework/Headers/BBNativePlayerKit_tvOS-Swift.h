...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BBNativePlayerKit_tvOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC22BBNativePlayerKit_tvOS18BBNativePlayerView")
...
SWIFT_PROTOCOL("_TtP22BBNativePlayerKit_tvOS26BBNativePlayerViewDelegate_")
