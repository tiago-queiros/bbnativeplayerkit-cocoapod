#
#  Be sure to run `pod spec lint BBNativePlayerKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/bluebillywig/bbnativeplayerkit-cocoapod", :tag => "#{spec.version}" }
